<div class="container">
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 d-flex justify-content-end align-items-center">
                ...
                @admin
                    <a class="btn btn-sm btn-outline-secondary" href="/admin">{{ config('auth.roles.admin') }}</a>
                @else
                    @moderator
                        <a class="btn btn-sm btn-outline-secondary" href="/admin">{{ config('auth.roles.moderator') }}</a>
                    @endmoderator
                @endadmin
                @guest
    ...
    <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex">
            ...
            <a class="p-2 link-secondary" href="{{ route('news.index') }}">Новости</a>
